								...
								<div class="row">
									...
									<div class="input-group">
										...
										<i class="fa fa-calendar bigger-110"></i>
                                                    ...
                                                    <div class="col-md-12" style="border: 0px solid #CCC; margin-bottom: 10px">                                                       
                                                        <div style="width: 100%">                                                            
                                                            <div style="width: 30%; float: left; margin-right: 10px">
                                                                <label>Empresa</label>
                                                    ...
                                                    <div class="col-md-12" style="border: 0px solid #CCC; margin-bottom: 5px">                                                       
                                                        <div style="width: 100%">                                                            
                                                            <div style="width: 30%; float: left; margin-right: 10px">
                                                                <label>Contacto</label>
                                                                <div id="contenedor03">
                                                                    <input type="text" id="fiscalavenida" name="fiscalavenida" placeholder="Calle o Avenida" style="width: 100%; font-size: 1.8ex; margin-bottom: 10px;margin-right: 0.5ex" maxlength="60" />
                                                                </div>
                                                            </div>                                                            
                                                        </div>                                                          
                                                    </div>
