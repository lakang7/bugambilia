...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bugambilia Buffets - Edición de Contacto</title>
			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					<div class="page-content">
                                                    ...
                                                    ?>
                                            <form method="post" id="form_crearEmpresa" action="recursos/acciones.php?tarea=9&id=<?php echo $_GET["id"]; ?>">
						<div class="page-header"><h1>Contactos<small><i class="ace-icon fa fa-angle-double-right"></i> Registro</small></h1></div>
						<div class="row">
                                                    <div class="col-md-6" style="border: 0px solid #CCC">
                                                        <?php
                                                            $con=Conexion();
                                                            $sql_AGENDA="select * from agenda where idagenda='".$_GET["id"]."'";
                                                            ...
                                                            $tipoasociacion=0;
                                                            $sql_ASOCIA="select * from asociacionagenda where idagenda='".$agenda["idagenda"]."'";
                                                            $result_ASOCIA=mysql_query($sql_ASOCIA,$con) or die(mysql_error());
                                                            if(mysql_num_rows($result_ASOCIA)>0){
                                                                $asociacion =  mysql_fetch_assoc($result_ASOCIA);
                                                                $tipoasociacion=$asociacion["tipo"];
                                                            }                                                                                                                                                                                    
                                                        ?>                                                        
                                                        
                                                        <div style="width: 100%; border-bottom: 1px solid #CCC; margin-bottom: 15px">Datos de Contacto</div>                                                        
                                                        <div style="width: 100%;">Tipo de Contacto</div>
                                                        <select class="chosen-select form-control" id="tipodeasociacion" name="tipodeasociacion" data-placeholder="Escoja el tipo de contacto">
                                                            <option value="">  </option>
                                                            <?php
                                                                if($tipoasociacion==0){
                                                                    echo "<option value='AE'>Asociado a Empresa</option>";
                                                                    echo "<option value='AS'>Asociado a Sucursal</option>";
                                                                    echo "<option value='AR'>Asociado a Región</option>";
                                                                    echo "<option value='SA' selected='selected'>Sin Asociacion</option>";
                                                                }else if($tipoasociacion==1){
                                                                    echo "<option value='AE' selected='selected'>Asociado a Empresa</option>";
                                                                    echo "<option value='AS'>Asociado a Sucursal</option>";
                                                                    echo "<option value='AR'>Asociado a Región</option>";
                                                                    echo "<option value='SA'>Sin Asociacion</option>";                                                                    
                                                                }else if($tipoasociacion==2){
                                                                    echo "<option value='AE'>Asociado a Empresa</option>";
                                                                    echo "<option value='AS' selected='selected'>Asociado a Sucursal</option>";
                                                                    echo "<option value='AR'>Asociado a Región</option>";
                                                                    echo "<option value='SA'>Sin Asociacion</option>";                                                                    
                                                                }else if($tipoasociacion==3){
                                                                    echo "<option value='AE'>Asociado a Empresa</option>";
                                                                    echo "<option value='AS'>Asociado a Sucursal</option>";
                                                                    echo "<option value='AR' selected='selected'>Asociado a Región</option>";
                                                                    echo "<option value='SA'>Sin Asociacion</option>";                                                                    
                                                                }
                                                            ?>
                                                        </select>
                                                            ...
                                                            if($tipoasociacion==1){
                                                                ...
                                                                if(mysql_num_rows($result_listaEMPRESA)>0){
                                                                    while ($fila = mysql_fetch_assoc($result_listaEMPRESA)) {
                                                                        if($fila["idempresa"]==$asociacion["idempresa"]){
                                                                ...
                                                                $sql_listaSUCURSAL="select * from sucursal where idempresa='".$asociacion["idempresa"]."' order by nombrecomercial";
                                                                ...
                                                                if(mysql_num_rows($result_listaSUCURSAL)>0){
                                                                    while ($fila = mysql_fetch_assoc($result_listaSUCURSAL)) {
                                                                        if($fila["idsucursal"]==$asociacion["idsucursal"]){
                                                                            echo "<option selected='selected' value='".$fila["idsucursal"]."'>".$fila["nombrecomercial"]."</option>";
                                                                        }else{
                                                                ...
                                                                $sql_listaESTSUCURSAL="select * from estadosensucursal where idsucursal='".$asociacion["idsucursal"]."'";
                                                                ...
                                                                if(mysql_num_rows($result_listaESTSUCURSAL)>0){
                                                                    while ($fila = mysql_fetch_assoc($result_listaESTSUCURSAL)) {
                                                                        ...
                                                                        if($fila02["idestado"]==$asociacion["idestado"]){
                                                                            echo "<option selected='selected' value='".$fila["idestado"]."'>".$fila02["nombre"]."</option>"; 
                                                                        }else{
                                                        ...
                                                        <div style="width: 100%; margin-top: 10px">(*) Referencia para el contacto</div>
                                                        <div style="width: 100%;"><input value="<?php echo $agenda["referencia"]; ?>" type="text" id="referencia" name="referencia" placeholder="Ingrese un nombre que le permita identificar rapidamente el contacto" style="width: 100%; font-size: 1.8ex;" maxlength="60" required="required" /></div>                                                        
                                                        <div style="width: 100%; margin-top: 10px">(*) Nombre</div>
                                                        <div style="width: 100%;"><input value="<?php echo $agenda["nombre"]; ?>" type="text" id="nombre" name="nombre" placeholder="Nombre del contacto" style="width: 100%; font-size: 1.8ex;" maxlength="60" required="required" /></div>                                                         
                                                        <div style="width: 100%; margin-top: 10px">(*) Teléfono Uno</div>
                                                        <div style="width: 100%;"><input value="<?php echo $agenda["telefono1"]; ?>" type="text" id="telefonouno" name="telefonouno" placeholder="Telefono del contacto" style="width: 100%; font-size: 1.8ex;" maxlength="30" required="required" /></div> 
                                                        <div style="width: 100%; margin-top: 10px">Teléfono Dos</div>
                                                        <div style="width: 100%;"><input value="<?php echo $agenda["telefono2"]; ?>" type="text" id="telefonodos" name="telefonodos" placeholder="Telefono del contacto" style="width: 100%; font-size: 1.8ex;" maxlength="30" /></div>                                                        
                                                        <div style="width: 100%; margin-top: 10px">(*) Correo Electrónico</div>
                                                        <div style="width: 100%;"><input value="<?php echo $agenda["email"]; ?>" type="text" id="correo" name="correo" placeholder="Correo Electrónico del contacto" style="width: 100%; font-size: 1.8ex;" maxlength="60" /></div>                                                         
                                                    </div>
						</div>
