...
if ($tarea == 1) {
    ...
    if ($result_insertEmpresa) {
        ...
        $sql_pais = "select pais.nombre NOM,pais.identificador ID from pais where idpais='" . $_POST["pais"] . "'";
         ...
         * idaccion =3 -> creacion
         */
        $descripcion = "'Se creo la empresa: " . $_POST["nombre"] . ", con el codigo: " . $codigo . ", de nombre comercial: " . $_POST["comercial"] . ", con los siguientes datos; Telefono: " . $_POST["telefono"] . ", Identificador: " . $_POST["rfc"] . ", Pais: " . $pais["NOM"] . ",Direccion Fiscal Av: " . $_POST["fiscalavenida"] . ",Direccion Fiscal Exterior: " . $_POST["fiscalexterior"] . ", Direccion Fiscal Interior: " . $_POST["fiscalinterior"] . ", Colonia: " . $_POST["fiscalcolonia"] . ", Ciudad: " . $_POST["fiscalciudad"] . ", Direccion Fiscal Estado: " . $_POST["fiscalestado"] . ", Codigo Postal: " . $_POST["fiscalpostal"] . ", Direccion de Entrega Av: " . $_POST["entregaavenida"] . ", Direccion Entrega Exterior: " . $_POST["entregaexterior"] . ", Direccion Entrega Interior: " . $_POST["entregainterior"] . ", Direccion Entrega Colonia: " . $_POST["entregacolonia"] . ", Direccion Entrega Ciudad: " . $_POST["entregaciudad"] . ", Direccion Entrega Estado: " . $_POST["entregaestado"] . ", Direccion Entrega Postal: " . $_POST["entregapostal"] . ", Direccion de Referencia: " . $_POST["entregareferencia"] . ", con el Impuesto: " . $_POST["iva"]."'";
...
if ($tarea == 2) {
    ...
    if ($result_insertSucursal == 1) {
        ...
        $descripcion = "'Se creo la sucursal:  " . $_POST["nombresucursal"] . ", en las siguiente regiones: " . $regiones . ", Perteneciente a la empresa: " . $empresa["NOMEM"] . ", de nombre comercial: " . $empresa["NOMCOM"] . "'";
...
if ($tarea == 3) {
    ...
    if ($result_insertContacto == 1) {
        ...
        $descripcion = "'Se creo el contacto:  " . $_POST["nombre"] . ", de la empresa: " . $empresa["NOMEM"] . ", de nombre comercial: " . $empresa["NOMCOM"] .", con la referencia: ". $_POST["referencia"].", con los telefonos: ".$_POST["telefonouno"].",".$_POST["telefonodos"].", y el correo: ".$_POST["correo"]."'";
