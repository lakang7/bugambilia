...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bugambilia Buffets - Registro de Listas de Precios</title>
			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					<div class="page-content"> 
                                                    ...
                                                    ?>
                                                <form method="post" id="form_crearListadePrecios" action="recursos/acciones.php?tarea=13">
						<div class="page-header"><h1>Lista de Precios<small><i class="ace-icon fa fa-angle-double-right"></i> Registro</small></h1></div>
						<div class="row">
                                                ...
                                                <button class="btn btn-info" style="margin-top: 10px" type="submit"><i class="ace-icon fa fa-check "></i>Registrar</button>                                                
					</div>
				</div>
                            </form>
			</div>
