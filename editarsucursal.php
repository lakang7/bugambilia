...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bugambilia Buffets - Edición de Sucursal</title>
			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					<div class="page-content"> 
                                                    ...
                                                    ?>
                                                <form method="post" id="form_crearEmpresa" action="recursos/acciones.php?tarea=8&id=<?php echo $_GET["id"];?>">
						...
						<div class="row">
                                                    <div class="col-md-6" style="border: 0px solid #CCC">
                                                        <?php
                                                            $con=Conexion();
                                                            $sql_sucursal="select * from sucursal where idsucursal='".$_GET["id"]."'";
                                                            $result_sucursal=mysql_query($sql_sucursal,$con) or die(mysql_error());
                                                            if(mysql_num_rows($result_sucursal)>0){
                                                        ...
                                                        <select class="chosen-select form-control" disabled="disabled" id="matriz" name="matriz" data-placeholder="Elija la empresa matriz" required="required">
                                                            <option value="">  </option>
                                                            <?php
                                                                $con=Conexion();
                                                                ...
                                                                if(mysql_num_rows($result_listaEMPRESA)>0){
                                                                    while ($fila = mysql_fetch_assoc($result_listaEMPRESA)) {
                                                                        if($fila["idempresa"]==$sucursal["idempresa"]){
                                                        ...
                                                        <div style="width: 100%;"><input value="<?php echo $sucursal["nombrecomercial"]; ?>" type="text" id="nombresucursal" name="nombresucursal" placeholder="Ingrese un nombre para la sucursal" style="width: 100%; font-size: 1.8ex;" maxlength="60" required="required" /></div>
                                                        ...
                                                        <div id="contenedor" >
                                                            ...
                                                            <?php
                                                                $con=Conexion();
                                                                $sql_empresa="select * from empresa where idempresa='".$sucursal["idempresa"]."'";
                                                                $result_empresa=mysql_query($sql_empresa,$con) or die(mysql_error());
                                                                $auxempresa=mysql_fetch_assoc($result_empresa);
                                                                
                                                                $sql_listaESTADO="select * from estado where idpais='".$auxempresa["idpais"]."' order by nombre";
                                                                ...
                                                                if(mysql_num_rows($result_listaESTADO)>0){
                                                                    while ($fila = mysql_fetch_assoc($result_listaESTADO)) {
                                                                        $sql_estsuc="select * from estadosensucursal where idestado='".$fila["idestado"]."' and idsucursal='".$_GET["id"]."'";
                                                                        $result_estsuc=mysql_query($sql_estsuc,$con) or die(mysql_error());
                                                                        if(mysql_num_rows($result_estsuc)>0){
                                                                            echo "<option selected='selected' value='".$fila["idestado"]."'>".$fila["nombre"]."</option>";
                                                                        }else{
