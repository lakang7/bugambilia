			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					<div class="page-content">
                                                    ...
                                                    ?>                                             
                                            <form enctype="multipart/form-data" method="post" id="form_crearPatron" action="recursos/acciones.php?tarea=6">
						...
						<div class="row">
                                                    <div class="col-md-6" style="border: 0px solid #CCC">                                                                                                                                                                        
                                                        ...
                                                        <div style="width: 100%;"><input type="text" id="espanol" name="espanol" placeholder="Ingrese el codigo del producto" style="width: 100%; font-size: 1.8ex;" maxlength="30" required="required" /></div>
                                                        <div style="width: 100%; margin-top: 10px">(*) Nombre en Ingles</div>
                                                        <div style="width: 100%;"><input type="text" id="ingles" name="ingles" placeholder="Ingrese la descripcion del producto" style="width: 100%; font-size: 1.8ex;" maxlength="200" required="required" /></div>
