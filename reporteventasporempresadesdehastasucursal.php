...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bugambilia Buffets - Reporte de Ventas Por Empresa y Sucursales</title>
			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					<div class="page-content">                                            
                                            <form enctype="multipart/form-data" target="_blank" method="post" id="form_crearPatron" action="pdfs/reportedeventasporempresaysucursal.php">
						<div class="page-header"><h1>Reporte De Ventas Por Empresa y Sucursales Desde - Hasta<small><i class="ace-icon fa fa-angle-double-right"></i> Generación</small></h1></div>
						<div class="row">
                                                    <div class="col-md-6" style="border: 0px solid #CCC">                                                                                                                                                                                                                                
                                                        ...
                                                        <div style="width: 100%; margin-top: 10px">Fecha hasta la cual se quiere emitir el reporte </div>
                                                        <div style="width: 100%;">                                                                
                                                            <div class="input-group">
                                                                <input class="form-control date-picker" id="id-date-picker-2" name="id-date-picker-2" type="text" data-date-format="yyyy-mm-dd" value="<?php echo date("Y")."-".date("m")."-".date("d"); ?>" />
                                                                <span class="input-group-addon">
                                                                    <i class="fa fa-calendar bigger-110"></i>
                                                                </span>
                                                            </div>                                                                                                                                                                                       
