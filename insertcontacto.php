...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bugambilia Buffets - Registro de Contacto</title>
			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					<div class="page-content"> 
                                                    ...
                                                    ?>
                                                <form method="post" id="form_crearEmpresa" action="recursos/acciones.php?tarea=3">
						...
						<div class="row">
                                                    <div class="col-md-6" style="border: 0px solid #CCC">
                                                        ...
                                                        <select class="chosen-select form-control" id="tipodeasociacion" name="tipodeasociacion" data-placeholder="Escoja el tipo de contacto">
                                                            <option value="">  </option>
                                                            <option value="AE">Asociado a Empresa</option>
                                                            <option value="AS">Asociado a Sucursal</option>
                                                            <option value="AR">Asociado a Región</option>
                                                            <option value="SA" selected="selected">Sin Asociacion</option>
                                                        </select> 
                                                        <div id="contenedor01" ></div>
                                                        <div style="width: 100%; margin-top: 10px">(*) Referencia para el contacto</div>
                                                        <div style="width: 100%;"><input type="text" id="referencia" name="referencia" placeholder="Ingrese un nombre que le permita identificar rapidamente el contacto" style="width: 100%; font-size: 1.8ex;" maxlength="60" required="required" /></div>                                                        
                                                        <div style="width: 100%; margin-top: 10px">(*) Nombre</div>
                                                        <div style="width: 100%;"><input type="text" id="nombre" name="nombre" placeholder="Nombre del contacto" style="width: 100%; font-size: 1.8ex;" maxlength="60" required="required" /></div>                                                         
                                                        <div style="width: 100%; margin-top: 10px">(*) Teléfono Uno</div>
                                                        <div style="width: 100%;"><input type="text" id="telefonouno" name="telefonouno" placeholder="Telefono del contacto" style="width: 100%; font-size: 1.8ex;" maxlength="30" required="required" /></div> 
                                                        <div style="width: 100%; margin-top: 10px">Teléfono Dos</div>
                                                        <div style="width: 100%;"><input type="text" id="telefonodos" name="telefonodos" placeholder="Telefono del contacto" style="width: 100%; font-size: 1.8ex;" maxlength="30" /></div>                                                        
                                                        <div style="width: 100%; margin-top: 10px">(*) Correo Electrónico</div>
                                                        <div style="width: 100%;"><input type="text" id="correo" name="correo" placeholder="Correo Electrónico del contacto" style="width: 100%; font-size: 1.8ex;" maxlength="60" /></div>                                                         
                                                    </div>
						</div>
