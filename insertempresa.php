						...
						<div class="page-header">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6" style="border: 0px solid #CCC">
                                                        ...
                                                        <div style="width: 100%;">
                                                            <select class="chosen-select form-control" id="pais" name="pais" data-placeholder="Seleccione el país al que pertenece la empresa" required="required">
                                                            <option value="">  </option>
                                                            <?php
                                                                $con=Conexion();
                                                        ...
                                                        <div style="width: 100%;"><input type="text" id="rfc" name="rfc" placeholder="rfc o identificador de la empresa" style="width: 100%; font-size: 1.8ex; margin-bottom: 0px" maxlength="40" required="required" /></div>
                                                        <div style="width: 100%; margin-top: 10px">(*) Nombre de la empresa</div>
                                                        <div style="width: 100%;"><input type="text" id="nombre" name="nombre" placeholder="nombre de la empresa" style="width: 100%; font-size: 1.8ex; margin-bottom: 10px" maxlength="120" required="required" /></div>
                                                        <div style="width: 100%;">Nombre Comercial</div>
                                                        <div style="width: 100%;"><input type="text" id="comercial" name="comercial" placeholder="nombre comercial" style="width: 100%; font-size: 1.8ex; margin-bottom: 10px"  maxlength="120" /></div>                                                        
                                                        <div style="width: 100%;">(*) Teléfono Principal</div>
                                                        <div style="width: 100%;"><input type="text" id="telefono" name="telefono" placeholder="teléfono principal" style="width: 100%; font-size: 1.8ex; margin-bottom: 10px" maxlength="30" required="required" /></div>                                                                                                                
                                                        <div style="width: 100%;">(*) Aplica IVA para esta empresa</div>                                                        
                                                        <div style="width: 100%;">
                                                            <select class="chosen-select form-control" id="iva" name="iva" data-placeholder="Seleccione el país al que pertenece la empresa" required="required">
                                                        ...
                                                        <div style="width: 100%;"><input type="text" id="comentarios" name="comentarios" placeholder="Comentarios de exportación" style="width: 100%; font-size: 1.8ex; margin-bottom: 10px"  maxlength="60" /></div>                                                        
                                                        ...
                                                        <div style="width: 100%">
                                                            ...
                                                            <input type="text" id="fiscalexterior" name="fiscalexterior" placeholder="Número Exterior" style="width: 22%; font-size: 1.8ex; margin-bottom: 10px;margin-right: 0.5ex" maxlength="30" />
                                                            <input type="text" id="fiscalinterior" name="fiscalinterior" placeholder="Número Interior" style="width: 21%; font-size: 1.8ex; margin-bottom: 10px" maxlength="30" />
                                                        </div>                                                                                                                
                                                        <div style="width: 100%;">
                                                            <input type="text" id="fiscalcolonia" name="fiscalcolonia" placeholder="Colonia" style="width: 24%; font-size: 1.8ex; margin-bottom: 10px;margin-right: 0.5ex" maxlength="60" />
                                                            <input type="text" id="fiscalciudad" name="fiscalciudad" placeholder="Ciudad" style="width: 24%; font-size: 1.8ex; margin-bottom: 10px;margin-right: 0.5ex" maxlength="30" />
                                                            <input type="text" id="fiscalestado" name="fiscalestado" placeholder="Estado" style="width: 24%; font-size: 1.8ex; margin-bottom: 10px;margin-right: 0.5ex" maxlength="30" />
                                                            <input type="text" id="fiscalpostal" name="fiscalpostal" placeholder="Código Postal" style="width: 24%; font-size: 1.8ex; margin-bottom: 10px" maxlength="10" />
                                                        </div>
                                                        <div style="width: 100%; border-bottom: 1px solid #CCC; margin-bottom: 15px">Dirección de Entrega</div>                                                        
                                                        <div style="width: 100%">
                                                            <input type="text" id="entregaavenida" name="entregaavenida" placeholder="Calle o Avenida" style="width: 54%; font-size: 1.8ex; margin-bottom: 10px;margin-right: 0.5ex" maxlength="60" />
                                                            <input type="text" id="entregaexterior" name="entregaexterior" placeholder="Número Exterior" style="width: 22%; font-size: 1.8ex; margin-bottom: 10px;margin-right: 0.5ex" maxlength="30" />
                                                            <input type="text" id="entregainterior" name="entregainterior" placeholder="Número Interior" style="width: 21%; font-size: 1.8ex; margin-bottom: 10px" maxlength="30" />
                                                        </div>                                                                                                                
                                                        <div style="width: 100%;">
                                                            <input type="text" id="entregacolonia" name="entregacolonia" placeholder="Colonia" style="width: 24%; font-size: 1.8ex; margin-bottom: 10px;margin-right: 0.5ex" maxlength="60" />
                                                            <input type="text" id="entregaciudad" name="entregaciudad" placeholder="Ciudad" style="width: 24%; font-size: 1.8ex; margin-bottom: 10px;margin-right: 0.5ex" maxlength="30" />
                                                            <input type="text" id="entregaestado" name="entregaestado" placeholder="Estado" style="width: 24%; font-size: 1.8ex; margin-bottom: 10px;margin-right: 0.5ex" maxlength="30" />
                                                            <input type="text" id="entregapostal" name="entregapostal" placeholder="Código Postal" style="width: 24%; font-size: 1.8ex; margin-bottom: 10px" maxlength="10" />
                                                        </div>
                                                        <div style="width: 100%;">
                                                            <input type="text" id="entregareferencia" name="entregareferencia" placeholder="Punto de Rederencia" style="width: 99%; font-size: 1.8ex; margin-bottom: 10px;margin-right: 0.5ex" maxlength="250" />
                                                        </div>                                                        
                                                    </div>
						</div>
