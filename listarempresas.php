...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bugambilia Buffets - Listado de Empresas</title>
					...
					<div class="page-content">
						...
						<div class="page-header">                                                
                                                    <?php
                                                        ...
                                                        if(habilitaMenu($_SESSION["usuario"],1,3,1)==1){
                                                        ...
                                                        /*Listar Empresas*/
                                                        if(habilitaMenu($_SESSION["usuario"],1,3,2)==1){
                                                ...
                                                <div class="row filtros_tabla">
                                                    ...
                                                    <div style="width: 20%; float: right; margin-right: 1ex">
                                                        <select class="chosen-select form-control" id="camfiltro" name="camfiltro" data-placeholder="Escoja la columna para filtrar">
                                                            <option value="empresa.codigo">Código</option>
                                                            <option value="empresa.identificador">Identificador</option>
                                                            <option value="empresa.nombreempresa">Nombre de la Empresa</option>
                                                            <option value="empresa.nombrecomercial">Nombre Comercial</option>
                                                        </select>
                                                    </div>                                                                                                        
                                                </div>
                                                <input type="hidden" id="campoordena" name="campoordena" value="empresa.codigo" >
                                                <input type="hidden" id="ordenordena" name="ordenordena" value="asc" >                                                
                                                <input type="hidden" id="pagina" name="pagina" value="1" >
                                                <div id="contenedortabla">
                                                <div class="row cabecera_tabla">
                                                    <div class="col-xs-2 columna_cabecera" onclick="ordena('empresa.codigo')">Código<i class="ace-icon glyphicon glyphicon-download" style="float: right"></i></div>
                                                    <div class="col-xs-2 columna_cabecera" onclick="ordena('empresa.identificador')">Identificador</div>
                                                    <div class="col-xs-3 columna_cabecera" onclick="ordena('empresa.nombreempresa')">Nombre de la Empresa</div>
                                                    <div class="col-xs-3 columna_cabecera" onclick="ordena('empresa.nombrecomercial')">Nombre Comercial</div>                                                    
						</div>
                                                <?php 
                                                    $sql_listaEMPRESA="select pais.nombre, empresa.idempresa, empresa.nombreempresa, empresa.nombrecomercial, empresa.identificador, empresa.codigo from empresa, pais where empresa.idpais = pais.idpais order by empresa.codigo asc";
