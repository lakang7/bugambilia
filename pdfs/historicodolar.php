...
$pdf->SetTitle('Reporte Historico Dolar');
...
$pdf->Cell(80, 6, "Informe Historico Cambio del Dolar", 0, 1, "R", 0, '', 0);
//$altura+=4;
...
$altura+=5;
$pdf->SetXY(13,$altura);
$pdf->Cell(60, 4,"Valor del Dolar", 1, 1, "C", 0, '', 0);
$pdf->SetXY(73,$altura);
...
$acumulaTotal=0;
$sqlHistorico="select * from historicocambiodolar order by idhistoricocambiodolar";
...
while ($historico = mysql_fetch_assoc($resultHistorico)) {
    ...
    $altura+=4.5;
    $pdf->SetXY(13,$altura);
    $pdf->Cell(60, 4,$historico["cambio"], 1, 1, "C", 0, '', 0);
    $pdf->SetXY(73,$altura);
...
$pdf->Output('Historico Cambio del Dolar.pdf', 'I');
