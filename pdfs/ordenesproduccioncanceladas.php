...
$pdf->SetTitle('Reporte Ordenes de Producción Canceladas');
...
$pdf->Cell(80, 6, "Informe Ordenes de Producción Canceladas", 0, 1, "R", 0, '', 0);
$altura+=4.50;
...
$sqlOrdenes="";
if($_POST["empresa"]==0){
    $sqlOrdenes="select * from ordendeproduccion where estatus=2 and fechaderegistro >= '".$_POST["id-date-picker-1"]."' order by fechaderegistro DESC";
}else{
    $sqlOrdenes="select * from ordendeproduccion where estatus=2 and fechaderegistro >= '".$_POST["id-date-picker-1"]."' and idempresa='".$_POST["empresa"]."' order by fechaderegistro DESC";
}
...
while ($orden = mysql_fetch_assoc($resultOrdenes)) {
    ...
    $pdf->SetXY(10,$altura);
    $pdf->writeHTMLCell(193,4,10,$altura,"<b>Fecha de Emisión: </b>".$fecha02[2]." de ".$meses[intval($fecha02[1])]." de ".$fecha02[0]." <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Código Orden de Compra:</b> ".$orden["codigoop"], 1, 0, false, true, "L");
