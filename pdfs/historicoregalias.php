...
$pdf->SetTitle('Reporte Historico de Regalias');
...
$pdf->Cell(80, 6, "Informe Historico de Regalias", 0, 1, "R", 0, '', 0);
//$altura+=4;
...
$altura+=5;
$pdf->SetXY(13,$altura);
$pdf->Cell(60, 4,"Porcentaje de Regalias", 1, 1, "C", 0, '', 0);
$pdf->SetXY(73,$altura);
...
$acumulaTotal=0;
$sqlHistorico="select * from historicoregalias order by idhistoricoregalias";
...
while ($historico = mysql_fetch_assoc($resultHistorico)) {
    ...
    $altura+=4.5;
    $pdf->SetXY(13,$altura);
    $pdf->Cell(60, 4,round($historico["porcentajeregalias"],0)."% ", 1, 1, "C", 0, '', 0);
    $pdf->SetXY(73,$altura);
...
$pdf->Output('Historico porcentaje de regalias.pdf', 'I');
