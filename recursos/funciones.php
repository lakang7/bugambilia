<?php
    ...
    function calcularprecio($idproducto,$idlistadeprecios){
        $con=  Conexion();
        $sql_buscaprecio="select * from productoslista where idproducto='".$idproducto."' and idlistadeprecios='".$idlistadeprecios."'";
        ...
        if($preciobuscado["excepcion"]!=0){
            $retorna=$preciobuscado["excepcion"];
        }else {
            $retorna=$preciobuscado["precio"];
        }                             
        return $retorna;
    }     
