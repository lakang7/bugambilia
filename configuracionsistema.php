						...
						<div class="page-header">                                                    
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6" style="border: 0px solid #CCC">
                                                        ...
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $configuracion["carpetabusqueda"]; ?>" id="carpetabusqueda" name="carpetabusqueda" placeholder="Carpeta para buscar en el sistema operativo" style="width: 100%; font-size: 1.8ex; margin-bottom: 10px"  maxlength="60" /></div>                                                        
                                                        
                                                        <div style="width: 100%; margin-top: 0px">RFC Para emisión de factura empresas extranjeras</div>
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $configuracion["rfcextranjero"]; ?>" id="rfcextranjero" name="rfcextranjero" placeholder="Carpeta para buscar en el sistema operativo" style="width: 100%; font-size: 1.8ex; margin-bottom: 10px"  maxlength="25" /></div>                                                        
