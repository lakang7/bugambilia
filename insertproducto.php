...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bugambilia Buffets - Registro de Producto</title>
					...
					<div class="page-content">  
						...
						<div class="row">
                                                    <div class="col-md-6" style="border: 0px solid #CCC">                                                                                                                                                                        
                                                        ...
                                                        <div style="width: 100%;"><input type="text" id="ancho" name="ancho" placeholder="Ingrese el ancho del producto en centimetros" style="width: 100%; font-size: 1.8ex;" maxlength="5" required="required" /></div>                                                        
                                                        <div style="width: 100%; margin-top: 10px">(*) Dimensión Alto (cm)</div>
                                                        <div style="width: 100%;"><input type="text" id="alto" name="alto" placeholder="Ingrese el alto del producto en centimetros" style="width: 100%; font-size: 1.8ex;" maxlength="5" required="required" /></div>
                                                        <div style="width: 100%; margin-top: 10px">Capacidad del Producto (lt)</div>
                                                        <div style="width: 100%;"><input type="text" id="capacidad" name="capacidad" placeholder="Ingrese la capacidad del producto en litros" style="width: 100%; font-size: 1.8ex;" maxlength="5" /></div>                                                                                                                                                                                                                                
                                                        <div style="width: 100%; margin-top: 10px">Peso del Producto (kg)</div>
                                                        <div style="width: 100%;"><input type="text" id="peso" name="peso" placeholder="Ingrese el peso del producto en kilogramos" style="width: 100%; font-size: 1.8ex;" maxlength="5" /></div>
                                                        <div style="width: 100%; margin-top: 10px">(*) Precio de Fabrica</div>
                                                        <div style="width: 100%;"><input type="text" id="precio" name="precio" placeholder="Ingrese el precio de fabrica del producto" style="width: 100%; font-size: 1.8ex;" maxlength="5" required="required" /></div>  
                                                        <div style="width: 100%; margin-top: 10px">(*) Regalias</div>
                                                        <div style="width: 100%;"><input type="text" id="regalias" name="regalias" placeholder="Ingrese el precio del producto con las regalias" style="width: 100%; font-size: 1.8ex;" maxlength="5" required="required" /></div>
                                                        <div style="width: 100%; margin-top: 10px">(*) Costo Estandarizado</div>
                                                        <div style="width: 100%;"><input type="text" id="estandarizado" name="estandarizado" placeholder="Ingrese el precio del producto con el costo estandarizado" style="width: 100%; font-size: 1.8ex;" maxlength="5" required="required" /></div>                                                        
                                                    </div>
						</div>
