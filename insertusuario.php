...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bugambilia Buffets - Registro de Usuario</title>
			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					<div class="page-content"> 
                                                    ...
                                                    ?>
                                            <form method="post" id="form_crearEmpresa" action="recursos/acciones.php?tarea=20" autocomplete="off" >
						...
						<div class="row">
                                                    <div class="col-md-6" style="border: 0px solid #CCC">
                                                        ...
                                                        <div style="width: 100%;"><input type="text" id="nombre" name="nombre" placeholder="Ingrese un nombre para el usuario" style="width: 100%; font-size: 1.8ex;" maxlength="60" required="required" /></div>                                                        
                                                        <div style="width: 100%; margin-top: 10px">(*) Correo</div>
                                                        <div style="width: 100%;"><input type="text" id="correo" name="correo" placeholder="Correo del usuario" style="width: 100%; font-size: 1.8ex;" maxlength="60" required="required" /></div>                                                         
                                                        <div style="width: 100%; margin-top: 10px">(*) Puesto</div>
                                                        <div style="width: 100%;"><input type="text" id="puesto" name="puesto" placeholder="Puesto del usuario dentro de la empresa" style="width: 100%; font-size: 1.8ex;" maxlength="60" required="required" /></div> 
                                                        <div style="width: 100%; margin-top: 10px">Teléfono</div>
                                                        <div style="width: 100%;"><input type="text" id="telefono" name="telefono" placeholder="Telefono del usuario" style="width: 100%; font-size: 1.8ex;" maxlength="20" /></div>                                                        
                                                        <div style="width: 100%; margin-top: 10px">(*) Nombre de Usuario</div>
                                                        <div style="width: 100%;"><input type="text" id="usuario" name="usuario" placeholder="Nick Name para el usuario" style="width: 100%; font-size: 1.8ex;" maxlength="20" autocomplete="off" /></div>                                                         
                                                        <div style="width: 100%; margin-top: 10px">(*) Contraseña</div>
                                                        <div style="width: 100%;"><input type="password" id="contrasena" name="contrasena" placeholder="Contraseña para el usuario" style="width: 100%; font-size: 1.8ex;" maxlength="20" /></div>                                                                                                                 
