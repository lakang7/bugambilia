...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bugambilia Buffets - Reporte de Hsitoricos</title>
			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					<div class="page-content">                                            
                                            <form enctype="multipart/form-data"  target="_blank"  method="post" id="form_crearPatron" action="recursos/acciones.php?tarea=29">
						<div class="page-header"><h1>Reporte de Historicos<small><i class="ace-icon fa fa-angle-double-right"></i> Generación</small></h1></div>
						<div class="row">
                                                    <div class="col-md-6" style="border: 0px solid #CCC">                                                                                                                                                                                                                                
                                                        ...
                                                        <div style="width: 100%;">Historico para la generación del reporte</div>
                                                        <div style="width: 100%;">
                                                            <select class="chosen-select form-control" id="tiporeporte" name="tiporeporte" data-placeholder="Seleccione el tipo de reporte" required="required">
                                                            <option value="1">Historico porcentaje (%) de Regalias</option>
                                                            <option value="2">Historico porcentaje (%) de Iva</option>
                                                            <option value="3">Historico Cambio del Dolar</option>
                                                        </select>                                                                                                                         
                                                        </div>                                                                                                                  
                                                    </div>
