                                                ...
                                                <div class="row filtros_tabla">
                                                    ...
                                                    <div style="width: 20%; float: right; margin-right: 1ex">
                                                        <select class="chosen-select form-control" id="camfiltro" name="camfiltro" data-placeholder="Escoja la columna para filtrar">
                                                            ...
                                                            <option value="empresa.nombreempresa">Empresa Matriz</option>
                                                            <option value="sucursal.nombrecomercial">Nombre Sucursal</option>
                                                            <option value="sucursal.regiones">Regiones</option>
                                                        </select>
                                                    </div>                                                                                                        
                                                </div>
                                                <input type="hidden" id="campoordena" name="campoordena" value="pais.nombre" >
                                                <input type="hidden" id="ordenordena" name="ordenordena" value="asc" >
                                                <input type="hidden" id="pagina" name="pagina" value="1" >
                                                <div id="contenedortabla">
                                                <div class="row cabecera_tabla">
                                                    <div class="col-xs-2 columna_cabecera" onclick="ordena('pais.nombre')">País<i class="ace-icon glyphicon glyphicon-download" style="float: right"></i></div>
                                                    <div class="col-xs-2 columna_cabecera" onclick="ordena('empresa.nombreempresa')">Empresa Matriz</div>
                                                    <div class="col-xs-3 columna_cabecera" onclick="ordena('sucursal.nombrecomercial')">Nombre Sucursal</div>
                                                    <div class="col-xs-3 columna_cabecera" onclick="ordena('sucursal.regiones')">Regiones</div>                                                    
						</div>
                                                <?php 
                                                    $sql_listaEMPRESA="select sucursal.idsucursal, pais.nombre, empresa.nombreempresa, sucursal.nombrecomercial, sucursal.regiones from pais, empresa, sucursal where sucursal.idempresa = empresa.idempresa and empresa.idpais = pais.idpais order by pais.nombre asc";
			...
			jQuery(function($) {
                ...
                <script type="text/javascript">
                    function ordena(columna){
                        ...
                        $("#contenedortabla").load("recursos/tablas.php", {tabla:"sucursales",campo:document.getElementById("campoordena").value,orden:document.getElementById("ordenordena").value,elementos:document.getElementById("elementos").value,camfiltro:document.getElementById("camfiltro").value,filtro:document.getElementById("filtro").value,pagina:document.getElementById("pagina").value}, function(){});                                                                                                        
                    }
