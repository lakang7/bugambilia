...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bugambilia Buffets - Listado de Patrones</title>
			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					<div class="page-content">
						...
						<div class="page-header"><h1>Patrones<small><i class="ace-icon fa fa-angle-double-right"></i> Listado</small></h1></div>
                                                ...
                                                <div class="row filtros_tabla">
                                                    ...
                                                    <div style="width: 20%; float: right; margin-right: 1ex">
                                                        <select class="chosen-select form-control" id="camfiltro" name="camfiltro" data-placeholder="Escoja la columna para filtrar">
                                                            ...
                                                            <option value="patronproducto.nombreespanol">Nombre en Español</option>
                                                            <option value="patronproducto.nombreingles">Nombre en Ingles</option>
                                                            <option value="patronproducto.materiales">Materiales</option>
                                                        </select>
                                                    </div>                                                                                                        
                                                </div>
                                                <input type="hidden" id="campoordena" name="campoordena" value="categoria" >
                                                <input type="hidden" id="ordenordena" name="ordenordena" value="asc" >                                                
                                                <input type="hidden" id="pagina" name="pagina" value="1" >
                                                <div id="contenedortabla">
                                                <div class="row cabecera_tabla">
                                                    <div class="col-xs-2 columna_cabecera" onclick="ordena('categoria')">Tipo de Producto<i class="ace-icon glyphicon glyphicon-download" style="float: right"></i></div>
                                                    <div class="col-xs-2 columna_cabecera" onclick="ordena('espanol')">Nombre en Español</div>
                                                    <div class="col-xs-3 columna_cabecera" onclick="ordena('ingles')">Nombre en Ingles</div>
                                                    <div class="col-xs-3 columna_cabecera" onclick="ordena('materiales')">Materiales</div>                                                    
						</div>
                                                <?php 
                                                    $sql_listaEMPRESA="select categoriaproducto.nombreespanol as categoria,patronproducto.nombreespanol as espanol, patronproducto.nombreingles as ingles, patronproducto.materiales as materiales, patronproducto.idpatronproducto from categoriaproducto, patronproducto where patronproducto.idcategoriaproducto = categoriaproducto.idcategoriaproducto order by categoriaproducto.nombreespanol asc";
			...
			jQuery(function($) {
                ...
                <script type="text/javascript">
                    function ordena(columna){
                        ...
                        $("#contenedortabla").load("recursos/tablas.php", {tabla:"patrones",campo:document.getElementById("campoordena").value,orden:document.getElementById("ordenordena").value,elementos:document.getElementById("elementos").value,camfiltro:document.getElementById("camfiltro").value,filtro:document.getElementById("filtro").value,pagina:document.getElementById("pagina").value}, function(){});                                                                                                        
                    }
