...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bugambilia Buffets - Edición de Material</title>
			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					<div class="page-content">  
                                                    ...
                                                    ?>                                             
                                                <form method="post" id="form_crearEmpresa" action="recursos/acciones.php?tarea=10&id=<?php echo $_GET["id"]; ?>">
						...
						<div class="row">
                                                    <div class="col-md-6" style="border: 0px solid #CCC">
                                                        <?php
                                                            $con=Conexion();
                                                            $sql_MATERIAL="select * from material where idmaterial='".$_GET["id"]."'";
                                                        ...
                                                        <div style="width: 100%;"><input value="<?php echo $material["codigo"]; ?>" type="text" id="codigomaterial" name="codigomaterial" placeholder="Ingrese el código para el material" style="width: 100%; font-size: 1.8ex;" maxlength="30" required="required" /></div>
                                                        <div style="width: 100%; margin-top: 10px">(*) Nombre del Material</div>
                                                        <div style="width: 100%;"><input value="<?php echo $material["nombre"]; ?>" type="text" id="nombrematerial" name="nombrematerial" placeholder="Ingrese el nombre del material" style="width: 100%; font-size: 1.8ex;" maxlength="30" required="required" /></div>                                                                                                               
                                                            ...
                                                            <?php
                                                                ...
                                                                if(mysql_num_rows($result_listaCOLOR)>0){
                                                                    while ($fila = mysql_fetch_assoc($result_listaCOLOR)) {
                                                                        $sql_consultaMaterial="select * from colorenmaterial where idmaterial='".$_GET["id"]."' and idcolor='".$fila["idcolor"]."'";
                                                                        $result_consultaMaterial=mysql_query($sql_consultaMaterial,$con) or die(mysql_error());
                                                                        if(mysql_num_rows($result_consultaMaterial)>0){
                                                                            echo "<option selected='selected' value='".$fila["idcolor"]."'>".$fila["nombre"]."</option>";
                                                                        }else{
                                                        ...
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $material["dias"]; ?>" id="dias" name="dias" placeholder="Ingrese el numero de dias para la fabricación de este material" style="width: 100%; font-size: 1.8ex;" maxlength="3" required="required" /></div>                                                                                                                 
                                                    </div>
						</div>
