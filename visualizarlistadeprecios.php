                                ...
                                while ($cattipo = mysql_fetch_assoc($result_cattipo)) {
                                    ...
                                    if ($cuenta > 0) {
                                        if ($bandera == 0) {
                                            ...
                                            echo "<div class='namematerial'>" . $cattipo["tipocategoria"] . "</div>";
                                        }
                                            ...
                                            while ($forma = mysql_fetch_assoc($result_formas)) {
                                                ...
                                                if (mysql_num_rows($result_producto) > 0) {
                                                    if ($bandera02 == 0) {
                                                        ...
                                                        echo "<div class='namecategoria2'>" . $forma["nombreespanol"] . "</div>";
                                                    }

                                                    $bandera02 = 1;
                                                    echo "<div class='row cabeceracategoria'>";
                                                    echo "<div class='col-xs-1'>Codigo</div>";
                                                    echo "<div class='col-xs-3'>Nombre</div>";
                                                    echo "<div class='col-xs-2'>Largo x Ancho x Alto (cm)</div>";
                                                    echo "<div class='col-xs-1'>Capacidad (lts)</div>";
                                                    echo "<div class='col-xs-1'>Peso (Kgs)</div>";
                                                    echo "<div class='col-xs-1'>Precio Fabrica ($)</div>";
                                                    echo "<div class='col-xs-1'>Regalias " . round($configuracion["regalias"], 2) . "%</div>";
                                                    echo "<div class='col-xs-1'>Costo Estandarizado</div>";
                                                    echo "<div class='col-xs-1'>Precio</div>";
                                                    echo "</div>";
                                                    while ($producto = mysql_fetch_assoc($result_producto)) {
                                                        ...
                                                        echo "<div class='col-xs-1'>" . $producto["codigo"] . "</div>";
