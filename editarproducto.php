					...
					<div class="page-content">
						...
						<div class="row">
                                                    <div class="col-md-6" style="border: 0px solid #CCC">                                                                                                                                                                        
                                                        ...
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $producto["dimensionlargo"]; ?>" id="largo" name="largo" placeholder="Ingrese el largo del producto en centimetros" style="width: 100%; font-size: 1.8ex;" maxlength="6" required="required" /></div>                                                         
                                                        <div style="width: 100%; margin-top: 10px">(*) Dimensión Ancho (cm)</div>
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $producto["dimensionancho"]; ?>" id="ancho" name="ancho" placeholder="Ingrese el ancho del producto en centimetros" style="width: 100%; font-size: 1.8ex;" maxlength="6" required="required" /></div>                                                        
                                                        <div style="width: 100%; margin-top: 10px">(*) Dimensión Alto (cm)</div>
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $producto["dimensionalto"]; ?>" id="alto" name="alto" placeholder="Ingrese el alto del producto en centimetros" style="width: 100%; font-size: 1.8ex;" maxlength="6" required="required" /></div>
                                                        <div style="width: 100%; margin-top: 10px">Capacidad del Producto (lt)</div>
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $producto["capacidad"]; ?>" id="capacidad" name="capacidad" placeholder="Ingrese la capacidad del producto en litros" style="width: 100%; font-size: 1.8ex;" maxlength="6" /></div>                                                                                                                                                                                                                                
                                                        <div style="width: 100%; margin-top: 10px">Peso del Producto (kg)</div>
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $producto["peso"]; ?>" id="peso" name="peso" placeholder="Ingrese el peso del producto en kilogramos" style="width: 100%; font-size: 1.8ex;" maxlength="6" /></div>
                                                        <div style="width: 100%; margin-top: 10px">(*) Precio de Fabrica</div>
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $producto["preciofabrica"]; ?>" id="precio" name="precio" placeholder="Ingrese el precio de fabrica del producto" style="width: 100%; font-size: 1.8ex;" maxlength="6" required="required" /></div>                                                                                                                                                                        
                                                    </div>
						</div>
