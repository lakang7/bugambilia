...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bugambilia Buffets - Edición de Producto</title>
                                                    ...
                                                    <div class="col-md-6" style="border: 0px solid #CCC">                                                                                                                                                                        
                                                        <?php
                                                            ...
                                                            if(mysql_num_rows($result_PRODUCTO)>0){
                                                                ...
                                                                $result_PATRON=mysql_query($sqlpatron,$con) or die(mysql_error());
                                                            ...
                                                            <?php
                                                                ...
                                                                if(mysql_num_rows($result_listaTIPO)>0){
                                                                    while ($fila = mysql_fetch_assoc($result_listaTIPO)) {
                                                                        if($producto["idtipoproducto"]==$fila["idtipoproducto"]){
                                                                            echo "<option selected='selected' value='".$fila["idtipoproducto"]."'>".$fila["nombre"]." (".round($fila["portipo"],2)."%)</option>";                                                                   
                                                                        }else{
                                                                ...
                                                                if(mysql_num_rows($result_listaTIPO)>0){
                                                                    while ($fila = mysql_fetch_assoc($result_listaTIPO)) {
                                                                        ...
                                                                        if(mysql_num_rows($result_buscaPatrones)>0){
                                                                            if($patron["idcategoriaproducto"]==$fila["idcategoriaproducto"]){
                                                                                echo "<option selected='selected' value='".$fila["idcategoriaproducto"]."'>".$fila["nombreespanol"]."</option>";                                                                   
                                                                            }else{
                                                        ...
                                                        <?php
                                                            ...
                                                            $sql_listaESTSUCURSAL="select * from patronproducto where idcategoriaproducto='".$patron["idcategoriaproducto"]."'";
                                                            echo $sql_listaESTSUCURSAL;
                                                            ...
                                                            if(mysql_num_rows($result_listaESTSUCURSAL)>0){
                                                                while ($fila = mysql_fetch_assoc($result_listaESTSUCURSAL)) {
                                                                    if($producto["idpatronproducto"]==$fila["idpatronproducto"]){
                                                                       echo "<option selected='selected' value='".$fila["idpatronproducto"]."'>".$fila["nombreespanol"]."</option>";  
                                                                    }else{
                                                        ...
                                                        ?>
                                                            ...
                                                            $sql_listaESTSUCURSAL="select * from materialespatron where idpatronproducto='".$producto["idpatronproducto"]."'";
                                                            $result_listaESTSUCURSAL=mysql_query($sql_listaESTSUCURSAL,$con) or die(mysql_error());
                                                            if(mysql_num_rows($result_listaESTSUCURSAL)>0){
                                                                while ($fila = mysql_fetch_assoc($result_listaESTSUCURSAL)) {
                                                                    ...
                                                                    if($producto["idmaterial"]==$material["idmaterial"]){
                                                                        echo "<option selected='selected' value='".$material["idmaterial"]."'>".$material["nombre"]."</option>";  
                                                                    }else{
                                                        ...
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $producto["dimensionancho"]; ?>" id="ancho" name="ancho" placeholder="Ingrese el ancho del producto en centimetros" style="width: 100%; font-size: 1.8ex;" maxlength="5" required="required" /></div>                                                        
                                                        <div style="width: 100%; margin-top: 10px">(*) Dimensión Alto (cm)</div>
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $producto["dimensionalto"]; ?>" id="alto" name="alto" placeholder="Ingrese el alto del producto en centimetros" style="width: 100%; font-size: 1.8ex;" maxlength="5" required="required" /></div>
                                                        <div style="width: 100%; margin-top: 10px">Capacidad del Producto (lt)</div>
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $producto["capacidad"]; ?>" id="capacidad" name="capacidad" placeholder="Ingrese la capacidad del producto en litros" style="width: 100%; font-size: 1.8ex;" maxlength="5" /></div>                                                                                                                                                                                                                                
                                                        <div style="width: 100%; margin-top: 10px">Peso del Producto (kg)</div>
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $producto["peso"]; ?>" id="peso" name="peso" placeholder="Ingrese el peso del producto en kilogramos" style="width: 100%; font-size: 1.8ex;" maxlength="5" /></div>
                                                        <div style="width: 100%; margin-top: 10px">(*) Precio de Fabrica</div>
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $producto["preciofabrica"]; ?>" id="precio" name="precio" placeholder="Ingrese el precio de fabrica del producto" style="width: 100%; font-size: 1.8ex;" maxlength="5" required="required" /></div>
                                                        <div style="width: 100%; margin-top: 10px">(*) Regalias</div>
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $producto["regalias"]; ?>" id="regalias" name="regalias" placeholder="Ingrese el precio del producto con las regalias" style="width: 100%; font-size: 1.8ex;" maxlength="5" required="required" /></div>
                                                        <div style="width: 100%; margin-top: 10px">(*) Costo Estandarizado</div>
                                                        <div style="width: 100%;"><input type="text" value="<?php echo $producto["estandarizado"]; ?>" id="estandarizado" name="estandarizado" placeholder="Ingrese el precio del producto con el costo estandarizado" style="width: 100%; font-size: 1.8ex;" maxlength="5" required="required" /></div>                                                        
                                                    </div>
						</div>
				...
				$(document).one('ajaxloadstart.page', function(e) {
					...
					$('.daterangepicker.dropdown-menu,.colorpicker.dropdown-menu,.bootstrap-datetimepicker-widget.dropdown-menu').remove();
                                ...
                                /*$('#tipo').change(function(){
                                    ...
                                    $("#contenedor").load("recursos/ajax.php", {tarea:7, id: selectedValue}, function(){                                                                                
					$('.chosen-select').chosen({allow_single_deselect:true}); 			                                                                                                                                                           
                                    });
                                }); */
					...
					$('.chosen-select').chosen({allow_single_deselect:true});
                                            ...
                                            $('#patron').change(function(){  
                                                $("#contenedor02").load("recursos/ajax.php", {tarea:8, id:document.getElementById("patron").value}, function(){
                                                    $('.chosen-select').chosen({allow_single_deselect:true});
                                                });                                                                                                                                                 
                                            });                                  
