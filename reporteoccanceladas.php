...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bugambilia Buffets - Reporte Ordenes de Compra Canceladas</title>
			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					<div class="page-content">                                            
                                            <form enctype="multipart/form-data" target="_blank" method="post" id="form_crearPatron" action="pdfs/ordenescompracanceladas.php">
